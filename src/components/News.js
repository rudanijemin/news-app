...
export default class News extends Component {
  ...
  async componentDidMount(){
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=e06dec00d91346d89993e9c7faee0e31&pageSize=${this.props.pageSize}`
  ...
  handlepre=async()=>{
    ...
    let url=`https://newsapi.org/v2/top-headlines?country=in&apiKey=e06dec00d91346d89993e9c7faee0e31&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
    this.setState({loading:true});
    let data = await fetch(url);
    let parseData = await data.json()
    console.log(parseData);
